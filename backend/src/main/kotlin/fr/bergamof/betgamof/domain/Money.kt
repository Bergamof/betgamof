...
/** Serialized as a plain JSON number of euros, e.g. `1088.5`. */
object MoneySerializer : KSerializer<Money> {
    ...
    override fun serialize(
        encoder: Encoder,
        value: Money,
    ) = encoder.encodeDouble(value.toEuros())

    override fun deserialize(decoder: Decoder) = Money.euros(decoder.decodeDouble())
}
