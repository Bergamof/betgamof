...
internal object BankrollsTable : LongIdTable("bankrolls") {
    val name = text("name")
...
internal object MontantesTable : LongIdTable("montantes") {
    val name = text("name")
...
internal object BetsTable : LongIdTable("bets") {
    val bankrollId = reference("bankroll_id", BankrollsTable)
...
internal object BetSelectionsTable : LongIdTable("bet_selections") {
...
internal object DisciplineRulesTable : LongIdTable("discipline_rules") {
    val kind = text("kind")
